...
Aqui, é interessante mostrar para as Pessoas Estudantes de onde vem os pacotes Python, por essa razão, abra a página do [PyPI](https://pypi.org) e mostre comom procurar por um pacote.
...
Levante a questão para as pessoas estudantes de quando essa função `populate_table_planets` deve ser invocada. Além disso, pergunte o que aconteceria se tentássemos popular o banco mais de uma vez.
